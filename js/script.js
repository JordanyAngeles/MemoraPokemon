...
const MAXIMOS_INTENTOS = 8, // Intentos máximos
    COLUMNAS = 4, // Columnas
    SEGUNDOS_ESPERA_VOLTEAR_IMAGEN = 1, // segundos para mostrar ambas imágenes
    NOMBRE_IMAGEN_OCULTA = "./img/Trasera.jpg"; // Imagen Trasera de las cartas
new Vue({
    el: "#app",
    data: () => ({
        ...
        memorama: [],
        // Coordenadas de la ultima carta
        ultimasCoordenadas: {
            indiceFila: null,
            indiceImagen: null,
        },
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "Acerca de",
                html: `Creado por <a href="https://github.com/JordanyAngeles">Jordany Angeles Neri</a>
                <br>
                `,
        ...
        // Alerta indicando que el jugador ha perdido; después
        ...
        // Alerta de victoria y reiniciar juego
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
        ...
        voltear(indiceFila, indiceImagen) {
            ...
            if (imagenSeleccionada.ruta === ultimaImagenSeleccionada.ruta) {
                ...
                this.ultimasCoordenadas.indiceFila = null;
                this.ultimasCoordenadas.indiceImagen = null;
                // Si ha encontrado una pareja se verifica si ha ganado
                if (this.haGanado()) {
